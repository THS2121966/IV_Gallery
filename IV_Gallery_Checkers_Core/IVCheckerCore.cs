...
//#define IV_G_CHECKERS_CORE_VER_048 //Old Version.
#define IV_G_CHECKERS_CORE_VER_048_with_055
...
#elif IV_G_CHECKERS_CORE_VER_048_with_055
        static public float iv_checker_dll_code_ver = 0.48f;
#endif
...
#elif IV_G_CHECKERS_CORE_VER_048_with_055
        static public float[] supported_vers_p_and_iv_c_c = new float[18] { 0.35f, 0.35f, 0.4f, 0.38f, 0.4f, 0.45f, 0.42f, 
            0.48f, 0.42f, 0.5f, 0.45f, 0.52f, 0.45f, 0.53f, 0.48f, 0.54f, iv_checker_dll_code_ver, 0.55f };
#endif
...
#elif IV_G_CHECKERS_CORE_VER_048_with_055
            if (main_prog_ver == supported_vers_p_and_iv_c_c[17] && iv_checker_dll_code_ver == supported_vers_p_and_iv_c_c[16])
#endif
            {
